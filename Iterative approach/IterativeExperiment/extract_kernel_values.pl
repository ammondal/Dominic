...
my $diffKernelFile = "Diffusion4/diff_Asthma_and_Allergy.txt";
...
my $asthmaPPIFile = "Data4/expt_Asthma_and_Allergy.txt";
...
my $laplMatrixRef = readFile2Array("Laplacian4/lapl_Asthma_and_Allergy.txt");
my $actualDKRef = $asthmaPPI_KernelRef;
...
writeArraySort($uniquePropablePPIs, "Results4/res_Asthma_and_Allergy.txt");
#=cut
